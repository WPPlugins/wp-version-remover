...
Description: It's a very simple plugin for remove version numebr(i.e http://domain.com/style.css?ver=xyz to  http://domain.com/style.css) and remove version generator tag.
...
if(!class_exists('WP_Version_Remover'))
{
    class WP_Version_Remover
    {
		...
		*/
		...
		{
			add_options_page('WP Version Remover Settings', 'WP Version Remover', 'manage_options', 'wp_remover_version', array(&$this, 'wrv_settings_page'));
    ...
    } // END class WP_Version_Remover
} // END if(!class_exists('WP_Version_Remover'))

if(class_exists('WP_Version_Remover'))
{
    // Installation and uninstallation hooks
    register_activation_hook(__FILE__, array('WP_Version_Remover', 'wvr_activate'));
    register_deactivation_hook(__FILE__, array('WP_Version_Remover', 'wvr_deactivate'));

    // instantiate the plugin class
    $wvr_plugin_template = new WP_Version_Remover();
	// Add a link to the settings page onto the plugin page
	if(isset($wvr_plugin_template))
	{
		...
		add_filter("plugin_action_links_$plugin", 'wvr_settings_link');
	}
}